...
public class RegisterController {
    ...
    @GetMapping("/get-last-users/{count}")
    public ResponseEntity<List<RegisterEntity>> getLastUsers(@PathVariable int count) {
        List<RegisterEntity> lastUsers = service.getLastUsers(count);
